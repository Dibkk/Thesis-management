...
import { Search, Filter, BookOpen, User, Calendar, Download, FileText, Tag, X, Eye, LayoutGrid, List, ChevronLeft, ChevronRight, Star, Shuffle, Menu, Sheet } from "lucide-react"
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <div>
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h1 className="text-4xl font-heading font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent tracking-tight">
                    Browse Theses
                  </h1>
                </div>
                <p className="text-muted-foreground text-lg">
                  Discover and explore academic research from our repository
                </p>
              </div>
              <motion.div
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            >
              <TabsList className="grid w-full grid-cols-2 h-11 bg-white/60 dark:bg-gray-800/60 backdrop-blur-xl border border-white/20 dark:border-gray-700/30 rounded-xl shadow-lg">
                <TabsTrigger
                  value="popular"
                  className="rounded-lg data-[state=active]:bg-gradient-to-r data-[state=active]:from-yellow-600 data-[state=active]:to-orange-600 data-[state=active]:text-white data-[state=active]:shadow-md data-[state=active]:shadow-yellow-500/30 transition-all duration-300 py-2 px-3 text-sm font-medium"
                >
                  Most Popular
                </TabsTrigger>
                <TabsTrigger
                  value="random"
                  className="rounded-lg data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-600 data-[state=active]:to-purple-600 data-[state=active]:text-white data-[state=active]:shadow-md data-[state=active]:shadow-purple-500/30 transition-all duration-300 py-2 px-3 text-sm font-medium"
                >
                  Discover
                </TabsTrigger>
              </TabsList>
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            >
              <p className="text-sm text-muted-foreground font-medium flex items-center gap-2">
                Showing{" "}
                <span className="px-2 py-0.5 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold rounded-md text-xs">
                  {indexOfFirstItem}-
                  {Math.min(indexOfLastItem, filteredTheses.length)}
                </span>{" "}
                of{" "}
                <span className="px-2 py-0.5 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-bold rounded-md text-xs">
              ...
              <div className="flex items-center gap-3">
                ...
                <Select value={sortBy} onValueChange={setSortBy}>
                  ...
                  <SelectContent className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border-gray-200 dark:border-gray-700">
                    <SelectItem
                      value="relevance"
                      className="focus:bg-blue-50 dark:focus:bg-blue-900/20 focus:text-blue-600"
                    >
                      📊 Sort by Relevance
                    </SelectItem>
                    <SelectItem
                      value="date"
                      className="focus:bg-purple-50 dark:focus:bg-purple-900/20 focus:text-purple-600"
                    >
                      📅 Sort by Date
                    </SelectItem>
                    <SelectItem
                      value="title"
                      className="focus:bg-pink-50 dark:focus:bg-pink-900/20 focus:text-pink-600"
                    >
                      🔤 Sort by Title
                    </SelectItem>
                  </SelectContent>
                        ...
                        >
                          <Card className="group relative overflow-hidden bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border-0 shadow-lg hover:shadow-2xl transition-all duration-500 h-full w-fit flex flex-col">
                            ...
                            <CardContent className="relative p-6 flex-1 space-y-4">
                              <div className="flex justify-between items-start gap-2">
                                ...
                                <Badge
                                  ...
                                  className={
                                    thesis.isPublic
                                      ? "text-xs text-blue-700 dark:text-blue-300 border-blue-300 dark:border-blue-700 bg-blue-50 dark:bg-blue-900/30 font-medium"
                                      : "text-xs text-orange-700 dark:text-orange-300 border-orange-300 dark:border-orange-700 bg-orange-50 dark:bg-orange-900/30 font-medium"
                                  }
                                >
                                ...
                                {thesis.keywords
                                  ...
                                  .map((keyword, idx) => (
                                    <Badge
                                      key={idx}
                                      variant="outline"
                                      className="text-[10px] px-2 py-0.5 bg-slate-100 text-slate-900 dark:bg-slate-800 dark:text-slate-100 border-slate-200 dark:border-slate-700 font-medium"
                                    >
                                      {keyword.trim()}
                                    </Badge>
                                  ))}
                            ...
                            <CardFooter className="relative p-6 pt-0 flex flex-col gap-3">
                              ...
                              <Button
                                className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white shadow-lg shadow-purple-500/30 hover:shadow-xl hover:shadow-purple-500/40 transition-all duration-300"
                                asChild
                              >
                                <Link href={`/browse/${thesis._id}`} >
                              ...
                              <div className="flex flex-col md:flex-row items-start gap-5">
                                ...
                                <div className="flex-1 min-w-0 space-y-3">
                                  ...
                                  <div className="flex items-center gap-2 flex-wrap">
                                    ...
                                    <Badge
                                      ...
                                      className={
                                        thesis.isPublic
                                          ? "text-xs text-blue-700 dark:text-blue-300 border-blue-300 dark:border-blue-700 bg-blue-50 dark:bg-blue-900/30 font-medium px-2.5 py-0.5"
                                          : "text-xs text-orange-700 dark:text-orange-300 border-orange-300 dark:border-orange-700 bg-orange-50 dark:bg-orange-900/30 font-medium px-2.5 py-0.5"
                                      }
                                    >
                                      {thesis.isPublic
                                        ? "🌐 Public"
                                      ...
                                      {thesis.keywords
                                        ...
                                        .map((keyword, idx) => (
                                          <Badge
                                            key={idx}
                                            variant="outline"
                                            className="text-[10px] px-2 py-0.5 bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-300 border-slate-200 dark:border-slate-700 font-medium"
                                          >
                                            {keyword.trim()}
                                          </Badge>
                                        ))}
                                ...
                                <div className="flex md:flex-col items-center gap-2 shrink-0 w-full md:w-auto">
                                  ...
                                  >
                                    ...
                                    >
                                      <a
                                        href={`/api/thesis/${thesis._id}/file`}
                                        download
