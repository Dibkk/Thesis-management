...
const reportTemplates = [
  {
    ...
    description:
      "Overview of all thesis submissions, approvals, and rejections",
    category: "Academic",
  ...
  return (
    <div className="p-6 mx-auto space-y-8 min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-purple-900/20 dark:to-blue-900/20">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-4xl font-heading font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent mb-2">
            Reports & Analytics
          </h1>
      ...
      <Card className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border-0 shadow-lg">
        <CardHeader>
          <CardTitle className="font-heading">Download Logs</CardTitle>
          <CardDescription>History of thesis downloads</CardDescription>
        </CardHeader>
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground flex items-center gap-2">
                          Downloaded by {log.userFullName}
                          <span className="w-1 h-1 rounded-full bg-muted-foreground/50" />
