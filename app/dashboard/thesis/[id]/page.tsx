...
export default function ThesisDetailPage() {
  ...
  return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-purple-900/20 dark:to-blue-900/20 px-4 py-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4 mx-auto">
              <Button variant="ghost" onClick={() => router.back()} className="pl-0 hover:pl-2 transition-all hover:bg-gradient-to-r hover:from-blue-500/10 hover:to-purple-500/10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mx-auto">
              ...
              <div className="lg:col-span-2 space-y-6">
                  <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
                      <TabsList className="grid w-full grid-cols-4 mb-4 h-11 bg-white/60 dark:bg-gray-800/60 backdrop-blur-xl border border-border/40 shadow-lg">
                          ...
                          <TabsTrigger value="feedback" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-600 data-[state=active]:to-purple-600 data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:shadow-blue-500/30 font-medium py-2.5">Feedback</TabsTrigger>
                      </TabsList>
                              ...
                              <CardHeader className="bg-muted/10 pb-6">
                                  <div className="flex justify-between items-start gap-4">
                                      ...
                                      <Badge variant="outline" className="mb-2 bg-gradient-to-r from-blue-500/10 to-purple-500/10 border-blue-500/30 font-medium">{thesis.thesis_id}</Badge>
                                          <CardTitle className="text-3xl font-heading font-bold leading-tight bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">{thesis.title}</CardTitle>
                                      </div>
                              ...
                              <CardContent>
                                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                                      {[1, 2, 3, 4, 5].map((num) => {
                                          ...
                                          return (
                                              <div key={num} className={`flex items-center space-x-3 p-3 rounded-lg border transition-colors ${chapters[key] ? 'bg-green-50 dark:bg-green-900/30 border-green-200 dark:border-green-700' : 'bg-card dark:bg-muted/10 border-border dark:border-muted/50'}`}>
                                                  <Checkbox 
                                                      id={key} 
                                                  ...
                                                  />
                                                  <Label htmlFor={key} className={`text-sm font-medium cursor-pointer ${chapters[key] ? 'text-green-700 dark:text-green-200' : 'text-foreground dark:text-gray-300'}`}>
                                                      Chapter {num} {chapters[key] && <span className="dark:text-green-300">(Passed)</span>}
                                                  </Label>
                                              </div>
                                          )
                                      })}
              ...
              <div className="lg:col-span-1 space-y-6">
                  {isAdvisor && (
                      <Card className="border-0 shadow-xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border-l-4 border-l-orange-400">
                      ...
                      <CardContent className="space-y-3">
                          ...
                          <Button variant="outline" className="w-full mt-2" asChild>
                              <Link href="/dashboard/upload#update">
                                  <UploadCloud className="mr-2 h-4 w-4" /> Upload New Chapter
                              </Link>
                          </Button>
